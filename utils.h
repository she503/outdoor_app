...
//    MESSAGE_CHASSIS_INFO = 203,
    MESSAGE_DRIVING_INFO = 203,
    MESSAGE_CLEANING_AGENCY_INFO = 204,
    MESSAGE_PERCEPTION_OBSTACLES = 205,
    MESSAGE_PLANNING_COMMAND_PATH = 206,
    MESSAGE_PLANNING_REF_LINE =207,
    MESSAGE_BATTERY_SOC = 208,
    MESSAGE_TRAJECTORY = 209,
    MESSAGE_MONITOR_MESSAGE = 210,
