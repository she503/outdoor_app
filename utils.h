...
enum MessageType {
    ...
    MESSAGE_CURRENT_MAP_AND_TASK = 110,
    MESSAGE_CURRENT_MAP_AND_TASK_RST = 111,
    MESSAGE_PAUSE_TASK = 112,
    MESSAGE_PAUSE_TASK_RST = 113,
    MESSAGE_STOP_TASK = 114,
    MESSAGE_STOP_TASK_RST = 115,

    MESSAGE_TASK_INFO = 200,
    MESSAGE_LOCALIZATION_INFO = 201,
    MESSAGE_CHASSIS_INFO = 202,
    MESSAGE_PERCEPTION_OBSTACLES = 203,
    MESSAGE_PLANNING_COMMAND_PATH = 204,
    MESSAGE_PLANNING_REF_LINE =205,
    MESSAGE_BATTERY_SOC = 206,
    MESSAGE_TRAJECTORY = 207,
    MESSAGE_MONITOR_MESSAGE = 208
};
